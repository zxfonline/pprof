...
//【change net/http/pprof/pprof.go add iptable filter method】
// To use pprof, link this package into your program:
//	import _ "github.com/zxfonline/pprof"
//
...
func init() {
	http.HandleFunc("/debug/pprof/", func(w http.ResponseWriter, req *http.Request) {
		if !iptable.IsTrustedIP(iptable.GetRemoteAddrIP(req.RemoteAddr)) {
